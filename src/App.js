...
function App() {
  ...
  const y = useTransform(scrollYProgress, [0,0.04], ["0%","82%"]);
  ...
  return (
    <>
        <div className='intro_section' id='intro' ref={ref}>
          {isMobile() && 
            <motion.div className='parallax_layer back_intro'>   
          ...
          <div className='parallax_layer front_intro' >
            <div className='main_text floating'> 
              ...
              <br/>
              {/* <span className="author_txt">-Sahil Patel &amp; Samia Menon</span>    */}
              </span>
