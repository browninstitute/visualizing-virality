...
function sketch(fp5) {
  ...
  fp5.draw = () => {
    ...
    if (user_on_network) {
      ...
      fp5.text(
        ...
        (1.3 * (fp5.displayWidth / 30)) / load_factor,
        (6.4 * fp5.displayHeight * 0.9) / 10 / load_factor
      );
      fp5.text(
        ...
        if (this.isSending) {
          ...
          if (
            ...
            fp5.text(
              ...
              this.position.x,
              this.position.y
            ); //fp5.displayWidth/5, 0.39*fp5.displayHeight);
  ...
  function restartNetwork() {
    ...
    if (!network_initial) {
      ...
      network_initial = Object.assign({}, network);
    } else {
      network = null;
      network = Object.assign({}, network_initial);
    }
