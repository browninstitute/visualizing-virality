...
export function SELECTION_SECTION(){
    ...
    const t1 = "data_c/links_tb.csv";
    const t2 = "data_c/nodes_tb.csv";
    const t3 = "data_c/users_tb.csv";
    const b1 = "data_c/links_black.csv";
    const b2 = "data_c/nodes_black.csv";
    const b3 = "data_c/users_black.csv";
    const m1 = "data_c/links_mccarthy.csv";
    const m2 = "data_c/nodes_mccarthy.csv";
    const m3 = "data_c/users_mccarthy.csv";
    ...
    const stepLinks = function (results, parser, maps) {
      ...
      if (row) {
        ...
        let parent_arr = maps.parentMap.get(id) || [];
        parent_arr.push(parent);
        maps.parentMap.set(id,parent_arr)
      }
    ...
    const [ refVN1, inViewN1 ] = useInView({amount:0});
    ...
    return (
        <>
            ...
            <div className='network_visible_container' ref={refVN1}>
                {loading &&
